...
```ts
const remindersController = new RemindersController(client);
```
...
try {
  const response = await remindersController.remindersAdd(
    token,
    text,
    time
  );
...
```ts
try {
  const response = await remindersController.remindersComplete();
...
```ts
try {
  const response = await remindersController.remindersDelete();
...
```ts
try {
  const response = await remindersController.remindersInfo();
...
```ts
try {
  const response = await remindersController.remindersList();
