...
```ts
const adminEmojiController = new AdminEmojiController(client);
```
...
try {
  const response = await adminEmojiController.adminEmojiAdd(
    token,
    name,
    url
  );
...
try {
  const response = await adminEmojiController.adminEmojiAddAlias(
    token,
    name,
    aliasFor
  );
...
try {
  const response = await adminEmojiController.adminEmojiList(token);
...
try {
  const response = await adminEmojiController.adminEmojiRemove(
    token,
    name
  );
...
try {
  const response = await adminEmojiController.adminEmojiRename(
    token,
    name,
    newName
  );
