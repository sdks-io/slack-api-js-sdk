...
try {
  const response = await teamController.teamAccessLogs(token);
...
try {
  const response = await teamController.teamBillableInfo(token);
...
try {
  const response = await teamController.teamInfo(token);
...
try {
  const response = await teamController.teamIntegrationLogs(token);
