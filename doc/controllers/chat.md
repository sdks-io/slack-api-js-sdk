...
```ts
try {
  const response = await chatController.chatDelete();
...
try {
  const response = await chatController.chatDeleteScheduledMessage(
    token,
    channel,
    scheduledMessageId
  );
...
try {
  const response = await chatController.chatGetPermalink(
    token,
    channel,
    messageTs
  );
...
```ts
try {
  const response = await chatController.chatMeMessage();
...
try {
  const response = await chatController.chatPostEphemeral(
    token,
    channel,
    user
  );
...
try {
  const response = await chatController.chatPostMessage(
    token,
    channel
  );
...
```ts
try {
  const response = await chatController.chatScheduleMessage();
...
try {
  const response = await chatController.chatUnfurl(
    token,
    channel,
    ts
  );
...
try {
  const response = await chatController.chatUpdate(
    token,
    channel,
    ts
  );
