...
```ts
try {
  const response = await filesController.filesDelete();
...
```ts
try {
  const response = await filesController.filesInfo();
...
```ts
try {
  const response = await filesController.filesList();
...
```ts
try {
  const response = await filesController.filesRevokePublicUrl();
...
```ts
try {
  const response = await filesController.filesSharedPublicUrl();
...
```ts
try {
  const response = await filesController.filesUpload();
