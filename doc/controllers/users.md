...
```ts
try {
  const response = await usersController.usersConversations();
...
try {
  const response = await usersController.usersDeletePhoto(token);
...
try {
  const response = await usersController.usersGetPresence(token);
...
```ts
try {
  const response = await usersController.usersIdentity();
...
try {
  const response = await usersController.usersInfo(token);
...
```ts
try {
  const response = await usersController.usersList();
...
try {
  const response = await usersController.usersLookupByEmail(
    token,
    email
  );
...
try {
  const response = await usersController.usersSetActive(token);
...
try {
  const response = await usersController.usersSetPhoto(token);
...
try {
  const response = await usersController.usersSetPresence(
    token,
    presence
  );
