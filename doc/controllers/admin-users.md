...
```ts
const adminUsersController = new AdminUsersController(client);
```
...
try {
  const response = await adminUsersController.adminUsersAssign(
    token,
    teamId,
    userId
  );
...
try {
  const response = await adminUsersController.adminUsersInvite(
    token,
    teamId,
    email,
    channelIds
...
try {
  const response = await adminUsersController.adminUsersList(
    token,
    teamId
  );
...
try {
  const response = await adminUsersController.adminUsersRemove(
    token,
    teamId,
    userId
  );
...
try {
  const response = await adminUsersController.adminUsersSetAdmin(
    token,
    teamId,
    userId
  );
...
try {
  const response = await adminUsersController.adminUsersSetExpiration(
    token,
    teamId,
    userId,
    expirationTs
...
try {
  const response = await adminUsersController.adminUsersSetOwner(
    token,
    teamId,
    userId
  );
...
try {
  const response = await adminUsersController.adminUsersSetRegular(
    token,
    teamId,
    userId
  );
