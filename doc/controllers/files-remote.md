...
```ts
const filesRemoteController = new FilesRemoteController(client);
```
...
```ts
try {
  const response = await filesRemoteController.filesRemoteAdd();
...
```ts
try {
  const response = await filesRemoteController.filesRemoteInfo();
...
```ts
try {
  const response = await filesRemoteController.filesRemoteList();
...
```ts
try {
  const response = await filesRemoteController.filesRemoteRemove();
...
```ts
try {
  const response = await filesRemoteController.filesRemoteShare();
...
```ts
try {
  const response = await filesRemoteController.filesRemoteUpdate();
