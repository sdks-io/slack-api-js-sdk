...
```ts
const usergroupsController = new UsergroupsController(client);
```
...
try {
  const response = await usergroupsController.usergroupsCreate(
    token,
    name
  );
...
try {
  const response = await usergroupsController.usergroupsDisable(
    token,
    usergroup
  );
...
try {
  const response = await usergroupsController.usergroupsEnable(
    token,
    usergroup
  );
...
try {
  const response = await usergroupsController.usergroupsList(token);
...
try {
  const response = await usergroupsController.usergroupsUpdate(
    token,
    usergroup
  );
