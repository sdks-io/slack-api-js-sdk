...
```ts
const adminTeamsSettingsController = new AdminTeamsSettingsController(client);
```
...
try {
  const response = await adminTeamsSettingsController.adminTeamsSettingsInfo(
    token,
    teamId
  );
...
try {
  const response = await adminTeamsSettingsController.adminTeamsSettingsSetDefaultChannels(
    token,
    teamId,
    channelIds
  );
...
try {
  const response = await adminTeamsSettingsController.adminTeamsSettingsSetDescription(
    token,
    teamId,
    description
  );
...
try {
  const response = await adminTeamsSettingsController.adminTeamsSettingsSetDiscoverability(
    token,
    teamId,
    discoverability
  );
...
try {
  const response = await adminTeamsSettingsController.adminTeamsSettingsSetIcon(
    token,
    imageUrl,
    teamId
  );
...
try {
  const response = await adminTeamsSettingsController.adminTeamsSettingsSetName(
    token,
    teamId,
    name
  );
