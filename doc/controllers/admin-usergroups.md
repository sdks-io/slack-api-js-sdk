...
```ts
const adminUsergroupsController = new AdminUsergroupsController(client);
```
...
try {
  const response = await adminUsergroupsController.adminUsergroupsAddChannels(
    token,
    usergroupId,
    channelIds
  );
...
try {
  const response = await adminUsergroupsController.adminUsergroupsAddTeams(
    token,
    usergroupId,
    teamIds
  );
...
try {
  const response = await adminUsergroupsController.adminUsergroupsListChannels(
    token,
    usergroupId
  );
...
try {
  const response = await adminUsergroupsController.adminUsergroupsRemoveChannels(
    token,
    usergroupId,
    channelIds
  );
